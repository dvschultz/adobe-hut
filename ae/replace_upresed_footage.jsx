        ...
        for (var i = 0; i < allFiles.length; i++) {
            ...
            if (fuzzyMode) {
                ...
                for (var key in compLookup) {
                    ...
                    if (upBaseName.toLowerCase().indexOf(key) !== -1) {
                        // Check for ambiguity: multiple upresed files matching the same original
                        if (matchTargets[key]) {
            ...
            if (matchedKey && matchedItem) {
                if (!matchTargets[matchedKey]) {
                    ...
                    // In suffix mode, mark as ambiguous if multiple upresed files match
